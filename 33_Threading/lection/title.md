...
1. можна ```global``` - можна примусити функцію, яка запущена у треді змінювати глобальну змінну. Але у такому випадку потрібно стежити, щоб у період роботи треду ця змінна більш ніким не використовувалась.
